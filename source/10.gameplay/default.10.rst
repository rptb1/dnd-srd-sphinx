...
+--------+-------------------+--------+--------+------------------------------------+
| **Pace | **Distance per:   | **Hour | **Day* | **Effect**                         |
| **     | Minute**          | **     | *      |                                    |
+========+===================+========+========+====================================+
| Fast   | 400 feet          | 4      | 30     | -5 penalty to passive Wisdom       |
|        |                   | miles  | miles  | (Perception) scores                |
+--------+-------------------+--------+--------+------------------------------------+
| Normal | 300 feet          | 3      | 18     | -                                  |
|        |                   | miles  | miles  |                                    |
+--------+-------------------+--------+--------+------------------------------------+
| Slow   | 200 feet          | 2      | 24     | Able to use stealth                |
|        |                   | miles  | miles  |                                    |
+--------+-------------------+--------+--------+------------------------------------+

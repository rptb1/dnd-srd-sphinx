...
You can use an action to press one side of the cube to cast the :ref:`gate` spell with it, opening a portal to the plane keyed to that side.
Alternatively, if you use an action to press one side twice, you can
cast the :ref:`plane shift` spell (save DC 17) with the cube and transport
